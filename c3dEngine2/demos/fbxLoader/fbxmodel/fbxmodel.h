...
public:
	...
	void setFbxMeshPtr(FbxMesh*fbxMeshPtr){m_fbxMeshPtr=fbxMeshPtr;}
	FbxMesh* getFbxMeshPtr(){return m_fbxMeshPtr;}
...
public:
	...
	Cc3dSkinMesh* findSkinMeshByFbxMeshPtr(FbxMesh*fbxMeshPtr){
